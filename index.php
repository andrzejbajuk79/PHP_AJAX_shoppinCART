      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <ul class="nav navbar-nav">
            ...
            <li><a href="#"><span class="glyphicon glyphicon-modal-window">About</a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"> Sign in</a>
                ...
                <div style="width: 300px;">
                  <div class="panel panel-primary">
                    ...
                    <div class="panel-heading">
                      ...
                      <input type="password" class="form-control" id="epassword" required="" name="">
            ...
            <li><a href="#"><span class="glyphicon glyphicon-user"> Sign out</a></li>
